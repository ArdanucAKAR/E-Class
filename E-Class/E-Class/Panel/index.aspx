<%@ Page Title="" Language="C#" MasterPageFile="~/Panel/Dash.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="E_Class.Panel.index" %>
                    ...
                    <div>
                        <div class="row">
                            <div class="card w-50" data-letter="A">
                                <img src="https://via.placeholder.com/180" class="mx-auto" height="180" alt="...">
                                <div class="card-body">
                            ...
                            <div class="card w-50" data-letter="B">
                                <img src="https://via.placeholder.com/1000" class="mx-auto" height="180" alt="...">

                                <div class="card-body">
                                    <h5 class="card-title">B şıkkı</h5>
                                    <p class="card-text">3 Ayaklıdır.</p>
                                </div>
                            </div>
                            ...
                            <div class="card w-50" data-letter="C">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">C şıkkı</h5>
                                    <p class="card-text">2 Ayaklıdır.</p>
                                </div>
                            </div>
                            <div class="card w-50" data-letter="D">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">D şıkkı</h5>
                                    <p class="card-text">1 Ayaklıdır.</p>
                                </div>
                            </div>
                        </div>
                    </div>
